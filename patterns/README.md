# HR AI Workflow Patterns

Reusable guardrails and operating patterns for practical HR AI workflows.

## Current patterns

- [Case File Workflow](case-file-workflow.md)
...
- [HR Writing Quality Gate](hr-writing-quality-gate.md)
- [Human Approval Pattern](human-approval-pattern.md)
- [Human Judgment Learning Loop](human-judgment-learning-loop.md)
...
- [Multi-Lens HR Brief](multi-lens-hr-brief.md)
